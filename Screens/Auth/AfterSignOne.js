...
import SignUpWantsToLearn from '../../components/SignUpWantsToLearn';
...
const AfterSignOne = ({ navigation }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            {page === 2 &&
                <>
                    <SignUpLanguage setPage={setPage} />
                </>
            }
            ...
            {page === 3 &&
                <>
                    <SignUpWantsToLearn setPage={setPage} />
                </>
            }
            ...
            {page === 4 &&
                <>
                    <SignUpLocation navigation={navigation} />
